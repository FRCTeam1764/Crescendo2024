...
music.AddDevice(ClimberMotor2);
  ...
  public void SetUpClimberMotors() {
    ...
    config.MotorOutput.PeakForwardDutyCycle = .5;
    config.MotorOutput.PeakReverseDutyCycle = -.5; // can bump up to 12 or something
      config2.Slot0.kP = 0.435; // prev .00003
    config2.Slot0.kD = 0.00005;

    config2.MotorOutput.NeutralMode = NeutralModeValue.Brake;
    config2.MotorOutput.PeakForwardDutyCycle = .5;
    config2.MotorOutput.PeakReverseDutyCycle = -.5; // can bump up to 12 or something
