...
public class AutoGroundPickUpShort extends SequentialCommandGroup {
  /** Creates a new AutoGroundPickUp. */
  public AutoGroundPickUpShort(SwerveSubsystem swerve,IntakeSubsystem intakeSubsystem, IntakeState intakeState,Shooter shooter) {
