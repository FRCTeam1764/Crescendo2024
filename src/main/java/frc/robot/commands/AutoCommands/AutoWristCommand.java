...
public class AutoWristCommand extends Command {
  ...
  public AutoWristCommand(IntakeSubsystem intake ,IntakeState intakeState, int desiredEncoderValue, boolean finish, boolean returns) {
